...
_8de(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",cleanText:"Clean",buttons:[{text:function(_8ef){
...
return $(k0).datebox("options").cleanText;
},handler:function(k1){
$(k1).datebox("setValue","");$(this).closest("div.combo-panel").panel("close");
}},{text:function(_8f1){
